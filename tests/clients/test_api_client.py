...
class TestApiClient:
    """Класс для тестирования ApiClient."""
    def test_get_postal_data_success(self, requests_mock, api_client):
    ...
    def test_get_postal_data_not_found(self, requests_mock, api_client):
    ...
    def test_get_postal_data_request_exception(self, requests_mock, api_client):
