...
def test_init_sqlalchemy_client(mock_connection):
...
def test_select_postal_code_found(mock_connection, mock_session):
...
def test_select_postal_code_not_found(mock_connection, mock_session):
...
def test_get_postal_code_from_db(mock_connection, mock_session):
...
def test_get_postal_code_from_db_not_found(mock_connection, mock_session):
...
def test_insert_postal_code(mock_connection, mock_session):
...
def test_increment_request_statistic(mock_connection, mock_session):
