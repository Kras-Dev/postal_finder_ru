...
def test_init_api_db_service(mock_db_client):
    """Тестирование инициализации ApiDBService."""
    service = ApiDBService(mock_db_client)
    assert service.db_client == mock_db_client

def test_fetch_postal_code_from_api_found(mock_db_client, mock_api_client):
...
def test_fetch_postal_code_from_api_not_found(mock_db_client, mock_api_client):
